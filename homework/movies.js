...
firebase.auth().onAuthStateChanged(async function (user){
  ...
  let apiKey = '06eedbe6a608cb7a6fd715ec5b069f32'
  ...
  if (user) {
    ...
    <div class ="text-green-200 font-5xl font-bold"> Signed in as ${user.displayName} </div>
    <button class="sign-out text-blue-200 font-4xl font-bold underline">Sign Out</button>
    `
